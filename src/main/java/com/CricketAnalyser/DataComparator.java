...
public class DataComparator {
    ...
    public enum DataFields {
        ...
        BATTING_AVERAGE, BATTING_STRIKING_RATE, SIXES, FOURS, SR_WITH_SIXES_AND_FOURS, AVG_WITH_SR, RUNS_WITH_AVG,
        BOWLING_AVERAGE, BOWLING_STRIKING_RATE, ECONOMY_RATE, AVG_WITH_WICKETS, SR_WITH_FIVE_AND_FOUR,
